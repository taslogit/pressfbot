                  ...
                  {selectedEvent.config.quests.map((quest) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-[10px] text-muted mb-1">{quest.description}</div>
                        <div className="flex items-center gap-2">
                  ...
                  {selectedEvent.config.rewards.map((reward) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-[9px] text-muted mb-2">{reward.description}</div>
                        ...
                        {canClaim && !claimed && (
                          <div className="mt-2 text-[9px] text-accent-lime font-bold uppercase">
                            {claiming === reward.id ? t('claiming') || 'Claiming...' : t('claim') || 'CLAIM'}
                          </div>
                        )}
                        {claimed && (
                          <div className="mt-2 text-[9px] text-muted font-bold uppercase">
                            {t('claimed') || 'CLAIMED'}
                          </div>
                        )}
                      </motion.button>
