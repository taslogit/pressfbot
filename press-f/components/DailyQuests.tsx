            ...
            >
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-[10px] text-muted">{quest.description}</div>
                </div>
                <div className="text-[10px] font-black text-accent-gold">
                  +{quest.reward} REP
                </div>
              </div>
              ...
              {quest.isCompleted && !quest.isClaimed && (
                <button
                  ...
                  className="ml-6 mt-1.5 bg-accent-cyan text-black text-[10px] font-black uppercase px-3 py-1 rounded-lg hover:scale-105 transition-transform"
                >
              ...
              {quest.isClaimed && (
                <div className="ml-6 mt-1.5 text-[10px] text-muted font-bold uppercase">
                  {t('claimed') || 'ЗАБРАНО'}
                </div>
              )}
            </div>
