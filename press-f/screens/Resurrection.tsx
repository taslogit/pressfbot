      ...
      <AnimatePresence>
        {!isRebooting ? (
            ...
            >
                ...
                <h1 className="font-display text-3xl font-black text-center mb-4 tracking-widest uppercase glitch-text text-red-500 drop-shadow-[0_0_12px_rgba(239,68,68,0.8)] flex items-center justify-center gap-3">
                ...
                <motion.button
                    ...
                    className="font-heading w-full py-6 bg-red-600 hover:bg-red-500 text-black font-black text-xl uppercase tracking-widest rounded-none border-2 border-red-500 shadow-[0_0_30px_rgba(255,0,0,0.4)] relative overflow-hidden group"
                >
