      ...
      <div className="relative z-10">
        ...
        <div className="flex bg-card/60 backdrop-blur-md rounded-xl p-1 mb-6 border border-border sticky top-0 z-20 shadow-xl">
          <button 
            ...
            className={`flex-1 py-3 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all duration-300 relative ${
          ...
          <button 
            ...
            className={`flex-1 py-3 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all duration-300 relative flex items-center justify-center gap-2 ${
            ...
            {!isCreating ? (
              ...
              >
                ...
                <div className="space-y-4">
                  <div>
                    <label className="text-[10px] text-muted uppercase font-bold tracking-wider mb-1 block">{t('duel_title_label')}</label>
                    <input 
                      value={title}
                  ...
                  <div>
                    <label className="text-[10px] text-muted uppercase font-bold tracking-wider mb-1 block">{t('duel_opponent_label')}</label>
                    <input 
                        value={opponent}
                  ...
                  <div>
                    <label className="text-[10px] text-muted uppercase font-bold tracking-wider mb-1 block">{t('duel_stake_label')}</label>
                    <input 
                      value={stake}
                    ...
                    <div className="mt-2 flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
                      {quickStakes.map(s => (
                        <button key={s} onClick={() => setStake(s)} className="whitespace-nowrap px-3 py-1 bg-orange-500/10 border border-orange-500/30 rounded-full text-[10px] font-bold text-orange-400">
                          {s}
                        </button>
                      ))}
                    </div>
        ...
        <div className="space-y-3 pb-20">
          {showSkeleton ? (
            ...
            >
              {activeTab === 'hype' && (
                <div className="absolute top-2 right-2 flex items-center gap-1 bg-red-500 text-white text-[10px] font-black px-2 py-0.5 rounded-full z-20">
              ...
              {activeTab === 'shame' && (
                <div className="absolute top-2 right-2 flex items-center gap-1 bg-gray-600 text-white text-[10px] font-black px-2 py-0.5 rounded-full z-20">
                  SHAME
                </div>
              )}
              ...
              <div className="flex items-center gap-2 text-xs text-muted mb-3 relative z-10">
                 ...
                 <span className="text-[10px] font-bold text-orange-500">{t('vs')}</span>
              ...
              {activeTab === 'shame' && duel.loser && (
                  <div className="text-[10px] bg-red-500/10 text-red-500 font-bold px-2 py-1 rounded mb-2">
                      LOSER: {duel.loser}
                  </div>
              )}
