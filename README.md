PRESS F
  ...
  PRESS F — это Telegram WebApp про тайники, дуэли и наследки. Работает как сейф с таймером, с публичной драмой и блокчейн‑доказательствами, но без слива контента. Быстро, дерзко и по делу 0)))
